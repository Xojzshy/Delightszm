...
// @ts-ignore
import belgianWaffleHeaven from './assets/images/belgian_waffle_heaven_1786469753774.jpg';
// @ts-ignore
import instagramCoffeeMoments from './assets/images/instagram_coffee_moments_1786469768245.jpg';
              ...
              <div className="space-y-6">
                ...
                <div className="p-5 bg-vanilla rounded-2xl border border-cream flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-chocolate">sweetdelites62@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="p-5 bg-vanilla rounded-2xl border border-cream flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-chocolate">+260 76 487 7489</p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="pt-8 border-t border-cream/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-cream/50">
            <div className="flex flex-col gap-1 text-left sm:text-left">
              ...
              <p>Developed by: nathanielsurrento@gmail.com</p>
            </div>
